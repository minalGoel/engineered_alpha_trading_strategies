"""Cement Sector Pairs — cursor_opus46max_136

Thesis: Cement companies share identical raw materials, pricing dynamics,
and demand drivers. Divergent stock reverts to group. Proxied by stock vs
index deviation z-score.
"""
import numpy as np
import polars as pl
...
class Strategy(BaseStrategy):
    name = "cursor_opus46max_136"
    is_long_only = False
    session_start = 570   # 09:30
    session_end = 915     # 15:15
    max_trades_per_day = 3
    assumptions = [
        "Cement group data not available; using stock vs index as proxy",
    ]
    ...
    def compute(self, df: pl.DataFrame, params: dict) -> StrategySignals:
        ...
        # Sector must be moving (non-flat)
        idx_ret = np.abs((idx_close - idx_day_open) / safe_ido * 10000.0)
        sector_active = idx_ret > 10.0
        ...
        long_entry = long_signal & dev_ok & sector_active & vix_ok & time_ok
        short_entry = short_signal & dev_ok & sector_active & vix_ok & time_ok
