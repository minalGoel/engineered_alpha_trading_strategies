"""Gap Fade Reversion — cursor_gemini31pro_strategy_104

Thesis: Overnight gaps caused by retail overreaction are often overextended.
Institutional participants fade the gap toward previous day's close.
15min timeframe. Gap threshold: 14 bps. VIX filter: < 25. Time stop: 30 bars.
"""
import numpy as np
import polars as pl
...
class Strategy(BaseStrategy):
    name = "gemini31pro_gap_fade_reversion_v104"
    is_long_only = False
    ...
    def tunable_params(self) -> list[TunableParam]:
        return [
            TunableParam("gap_thresh_bps", default=14.0, low=5.0, high=40.0),
    ...
    def compute(self, df: pl.DataFrame, params: dict) -> StrategySignals:
        gap_thresh = params.get("gap_thresh_bps", 14.0)
