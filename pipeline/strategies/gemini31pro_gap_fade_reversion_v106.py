"""Gap Fade Reversion — cursor_gemini31pro_strategy_106

Thesis: Overnight gaps caused by retail overreaction are often overextended.
5min timeframe, nifty50 universe. Gap threshold: 20 bps. VIX < 25.
Time stop: 15 bars (shorter hold).
"""
import numpy as np
import polars as pl
...
class Strategy(BaseStrategy):
    name = "gemini31pro_gap_fade_reversion_v106"
    is_long_only = False
    ...
    def tunable_params(self) -> list[TunableParam]:
        return [
            TunableParam("gap_thresh_bps", default=20.0, low=10.0, high=50.0),
    ...
    def compute(self, df: pl.DataFrame, params: dict) -> StrategySignals:
        gap_thresh = params.get("gap_thresh_bps", 20.0)
