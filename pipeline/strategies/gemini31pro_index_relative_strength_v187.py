"""Index Relative Strength — cursor_gemini31pro_strategy_187

Thesis: Stocks showing resilience while index falls explode upwards when the
index stabilizes. 15min timeframe, FNO universe. ROC lookback: 20.
Index threshold: -30 bps, stock > 2.9 bps.
...
class Strategy(BaseStrategy):
    name = "gemini31pro_index_relative_strength_v187"
    is_long_only = False
    session_start = 570
    session_end = 915
    ...
    def tunable_params(self) -> list[TunableParam]:
        return [
            ...
            TunableParam("stock_thresh", default=2.9, low=1.0, high=5.0),
    ...
    def compute(self, df: pl.DataFrame, params: dict) -> StrategySignals:
        ...
        stock_thresh = params.get("stock_thresh", 2.9)
