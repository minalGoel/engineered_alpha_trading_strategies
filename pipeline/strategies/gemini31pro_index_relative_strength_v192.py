"""Index Relative Strength — cursor_gemini31pro_strategy_192

Thesis: Stocks showing resilience while index falls explode upwards when the
index stabilizes. 15min timeframe, nifty200. ROC lookback: 21.
Index threshold: -20 bps, stock > 2.3 bps.
No VIX filter. No volume filter. Target: VWAP cross. Time stop: 15 bars.
"""
import numpy as np
import polars as pl
...
class Strategy(BaseStrategy):
    name = "gemini31pro_index_relative_strength_v192"
    is_long_only = False
    session_start = 570
    session_end = 915
    ...
    def tunable_params(self) -> list[TunableParam]:
        return [
            ...
            TunableParam("stock_thresh", default=2.3, low=0.5, high=5.0),
    ...
    def compute(self, df: pl.DataFrame, params: dict) -> StrategySignals:
        ...
        stock_thresh = params.get("stock_thresh", 2.3)
        ...
        index_ret = _roc(index_close, 21)
        stock_ret = _roc(close, 21)
