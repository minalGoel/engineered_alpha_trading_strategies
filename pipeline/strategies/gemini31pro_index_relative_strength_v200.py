"""Index Relative Strength — cursor_gemini31pro_strategy_200

Thesis: Stocks showing resilience while index falls explode upwards when the
index stabilizes. 15min timeframe, nifty50. ROC lookback: 50.
Index threshold: -20 bps, stock > 3.0 bps.
VIX > 15. Volume: rel_vol > 1.2. Target: VWAP cross. Time stop: 15 bars.
"""
import numpy as np
import polars as pl
...
class Strategy(BaseStrategy):
    name = "gemini31pro_index_relative_strength_v200"
    is_long_only = False
    session_start = 570
    session_end = 915
    ...
    def tunable_params(self) -> list[TunableParam]:
        return [
            ...
            TunableParam("stock_thresh", default=3.0, low=1.0, high=6.0),
    ...
    def compute(self, df: pl.DataFrame, params: dict) -> StrategySignals:
        ...
        stock_thresh = params.get("stock_thresh", 3.0)
        ...
        index_ret = _roc(index_close, 50)
        stock_ret = _roc(close, 50)
