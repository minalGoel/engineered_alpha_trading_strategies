"""RSI Connors Pullback v46 — Gemini31Pro Strategy 046
...
class Strategy(BaseStrategy):
    name = "gemini31pro_rsi_connors_pullback_v46"
    is_long_only = False
    session_start = 570
    session_end = 915
