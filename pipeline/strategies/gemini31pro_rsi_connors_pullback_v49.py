"""RSI Connors Pullback v49 — Gemini31Pro Strategy 049
...
class Strategy(BaseStrategy):
    name = "gemini31pro_rsi_connors_pullback_v49"
    is_long_only = False
    session_start = 570
    session_end = 915
    ...
    def compute(self, df: pl.DataFrame, params: dict) -> StrategySignals:
        rsi_long_thresh = params.get("rsi_long_thresh", 50.0)
        ...
        # ── Entries ──
        long_entry = (close > sma_200) & (rsi_2 < rsi_long_thresh) & vol_ok & time_ok
        short_entry = (close < sma_200) & (rsi_2 > rsi_short_thresh) & vol_ok & time_ok
