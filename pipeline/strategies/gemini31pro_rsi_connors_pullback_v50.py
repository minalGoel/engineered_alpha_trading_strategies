"""RSI Connors Pullback v50 — Gemini31Pro Strategy 050
...
VIX < 25. No volume filter. Time stop 120 bars.
"""
import numpy as np
import polars as pl
...
class Strategy(BaseStrategy):
    name = "gemini31pro_rsi_connors_pullback_v50"
    is_long_only = False
    session_start = 570
    session_end = 915
    ...
    def compute(self, df: pl.DataFrame, params: dict) -> StrategySignals:
        ...
        # ── Entries ──
        long_entry = (close > sma_200) & (rsi_2 < rsi_long_thresh) & vix_ok & time_ok
        short_entry = (close < sma_200) & (rsi_2 > rsi_short_thresh) & vix_ok & time_ok
