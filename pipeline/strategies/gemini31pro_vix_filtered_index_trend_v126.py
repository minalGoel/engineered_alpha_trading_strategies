"""VIX Filtered Index Trend — cursor_gemini31pro_strategy_126

Thesis: EMA(9)/EMA(21) crossover with VWAP confirmation when VIX > 14.
1min timeframe, nifty200. VIX filter: 12-22 range. Target: 30 ATR. Time stop: 120 bars.
"""
import numpy as np
import polars as pl
...
class Strategy(BaseStrategy):
    name = "gemini31pro_vix_filtered_index_trend_v126"
    is_long_only = False
    ...
    def tunable_params(self) -> list[TunableParam]:
        return [
            TunableParam("vix_entry_min", default=14.0, low=8.0, high=25.0),
            TunableParam("vix_filter_low", default=12.0, low=8.0, high=18.0),
            TunableParam("vix_filter_high", default=22.0, low=18.0, high=30.0),
    ...
    def compute(self, df: pl.DataFrame, params: dict) -> StrategySignals:
        vix_entry = params.get("vix_entry_min", 14.0)
        vix_flo = params.get("vix_filter_low", 12.0)
        vix_fhi = params.get("vix_filter_high", 22.0)
        ...
        vix_filter_ok = (vix >= vix_flo) & (vix <= vix_fhi)
