"""VWAP Mean Reversion v10 — Gemini31Pro Strategy 010
...
Z-score thresh -2.3/+2.3, rel vol > 1.4. VIX between 12-22.
Time stop 120 bars.
"""
import numpy as np
import polars as pl
...
class Strategy(BaseStrategy):
    name = "gemini31pro_vwap_mean_reversion_v10"
    is_long_only = False
    session_start = 570
    session_end = 915
    ...
    def tunable_params(self) -> list[TunableParam]:
        return [
            TunableParam("zscore_thresh", default=2.3, low=1.5, high=3.0),
            TunableParam("rel_vol_thresh", default=1.4, low=0.8, high=2.2),
    ...
    def compute(self, df: pl.DataFrame, params: dict) -> StrategySignals:
        zs_thresh = params.get("zscore_thresh", 2.3)
        rel_vol_thresh = params.get("rel_vol_thresh", 1.4)
