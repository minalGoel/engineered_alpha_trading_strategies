"""VWAP Mean Reversion v11 — Gemini31Pro Strategy 011
...
Z-score thresh -2.5/+2.5, rel vol > 1.4. VIX < 25.
Time stop 15 bars.
"""
import numpy as np
import polars as pl
...
class Strategy(BaseStrategy):
    name = "gemini31pro_vwap_mean_reversion_v11"
    is_long_only = False
    session_start = 570
    session_end = 915
    ...
    def tunable_params(self) -> list[TunableParam]:
        return [
            TunableParam("zscore_thresh", default=2.5, low=1.5, high=3.5),
    ...
    def compute(self, df: pl.DataFrame, params: dict) -> StrategySignals:
        zs_thresh = params.get("zscore_thresh", 2.5)
