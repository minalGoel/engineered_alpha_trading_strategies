"""VWAP Mean Reversion v12 — Gemini31Pro Strategy 012

Thesis: Retail panic sells push price far below VWAP; institutions fade.
Uses stddev(20) for z-score, SMA(volume,20) for rel vol.
Z-score thresh -1.6/+1.6, rel vol > 1.4. VIX < 25.
Time stop 15 bars.
"""
import numpy as np
import polars as pl
...
class Strategy(BaseStrategy):
    name = "gemini31pro_vwap_mean_reversion_v12"
    is_long_only = False
    session_start = 570
    session_end = 915
    ...
    def tunable_params(self) -> list[TunableParam]:
        return [
            TunableParam("zscore_thresh", default=1.6, low=1.0, high=2.5),
    ...
    def compute(self, df: pl.DataFrame, params: dict) -> StrategySignals:
        zs_thresh = params.get("zscore_thresh", 1.6)
