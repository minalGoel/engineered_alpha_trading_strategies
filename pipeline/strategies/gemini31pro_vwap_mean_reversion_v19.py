"""VWAP Mean Reversion v19 — Gemini31Pro Strategy 019
...
Z-score thresh -2.1/+2.1, rel vol > 1.7. No VIX filter.
Time stop 30 bars.
"""
import numpy as np
import polars as pl
...
class Strategy(BaseStrategy):
    name = "gemini31pro_vwap_mean_reversion_v19"
    is_long_only = False
    session_start = 570
    session_end = 915
    ...
    def tunable_params(self) -> list[TunableParam]:
        return [
            TunableParam("zscore_thresh", default=2.1, low=1.2, high=3.0),
    ...
    def compute(self, df: pl.DataFrame, params: dict) -> StrategySignals:
        zs_thresh = params.get("zscore_thresh", 2.1)
